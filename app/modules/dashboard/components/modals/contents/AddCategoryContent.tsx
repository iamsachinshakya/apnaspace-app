...
export function AddCategoryContent({ onClose, data }: AddCategoryContentProps) {
  ...
  return (
    <div className="relative w-full bg-gradient-to-br from-gray-800/95 to-gray-900/95 backdrop-blur-xl rounded-3xl border border-purple-500/30 shadow-2xl shadow-purple-500/20">
      {/* Glowing accents */}
        ...
        <div className="space-y-4">
              ...
              {colorOptions.map((color) => (
                <button
                  ...
                  className={`relative p-4 rounded-xl ${
                    ...
                    formData.color === color.value ? "ring-4 ring-white/50" : ""
                  }`}
                >
          ...
          <div className="flex gap-3 pt-2">
            <button
              ...
              disabled={isLoading}
              className="flex-1 flex items-center justify-center gap-2 px-6 py-2.5 bg-gradient-to-r from-purple-500 to-cyan-500 rounded-xl hover:scale-105 transition-all shadow-lg shadow-purple-500/25 font-semibold disabled:opacity-50 disabled:cursor-not-allowed disabled:hover:scale-100"
            >
              {isLoading ? (
                <>
